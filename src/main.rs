...
fn test_add_instruction() {
    ...
    let mut lc3 = Vm::new();
    lc3.register.write(Register::PC, PC_START);
    lc3.register.write(Register::R2, 10);
    lc3.register.write(Register::R3, 5);
    // ADD R1, R2, R3 (R1 = R2 + R3 = 10 + 5 = 15)
    lc3.memory.store(PC_START, 0b0001_001_010_0_00011);
    
    let instr = lc3.memory.mem_read(Register::PC, &mut lc3.register).unwrap();
    ...
    println!("Condition Code: {}", lc3.register.locations[Register::CC as usize]);
    assert!(lc3.register.locations[1] == 15, "Expected positive result 15");
    assert!(lc3.register.locations[Register::CC as usize] > 0, "Expected positive flag");
    ...
    let mut lc3 = Vm::new();
    lc3.register.write(Register::PC, PC_START);
    lc3.register.write(Register::R2, 5);
    lc3.register.write(Register::R3, 65531); // -5 in 16-bit two's complement (0xFFFB)
    ...
    assert!(lc3.register.locations[Register::CC as usize] == 2, "Expected zero flag");
    ...
    lc3.register.write(Register::PC, PC_START);
    lc3.register.write(Register::R2, 5);
    lc3.register.write(Register::R3, 65526); // -10 in 16-bit two's complement (0xFFF6)
    ...
    assert!(lc3.register.locations[Register::CC as usize] == 4, "Expected negative flag (4)");
